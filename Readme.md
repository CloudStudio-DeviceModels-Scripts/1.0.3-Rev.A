...
# Parsing + Configuration Script – 1.0.3 - Rev. A

This **Parsing + Configuration** script is designed for the **1.0.3** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – 1.0.3 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **1.0.3** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
